...
### Problem 2.66 <span id=recpoints>{5}</span><span id=report>{ A=0 | E=0 }</span> 
...
### Problem 2.25 <span id=recpoints>{5}</span><span id=report>{ A=0 | E=0 }</span>
...
### Problem 2.26 <span id=recpoints>{4}</span><span id=report>{ A=0 | E=0 }</span>
...
### Problem 2.29 <span id=recpoints>{5}</span><span id=report>{ A=0 | E=0 }</span> 
